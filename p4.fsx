...
let all_3x3_pals = [ for i in 100..999 do for j in i..999 do if IsPalindrome (i*j) then yield i*j ]

printfn "Found %d palindromes" all_3x3_pals.Length
    
printfn "Answer: %d " (List.max all_3x3_pals)
